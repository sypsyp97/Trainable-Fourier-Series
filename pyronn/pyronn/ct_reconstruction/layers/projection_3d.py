...
class ConeProjection3DFunction(Function):
    ...
    def forward(
        ...
        trajectory: Tensor,
        projection_multiplier: Tensor,
        step_size: Tensor,
        hardware_interp: Tensor,
    ) -> Tensor:
        """
        ...
        Args:
                ...
                ...
        """
        outputs = pyronn_layers.cone_projection3d(
            input,
            sinogram_shape,
            volume_origin,
            volume_spacing,
    ...
    def backward(ctx, grad: Tensor) -> tuple:
        ...
        outputs = pyronn_layers.cone_backprojection3d(
            grad,
            volume_shape,
            volume_origin,
            volume_spacing,
...
class ConeProjection3D(nn.Module):
    ...
    def forward(self, input: Tensor, **geometry: dict) -> Tensor:
        return ConeProjection3DFunction.apply(
            input,
            geometry["sinogram_shape"],
            geometry["volume_origin"],
            geometry["volume_spacing"],
            geometry["trajectory"],
            geometry["projection_multiplier"],
            geometry["step_size"],
            self.hardware_interp,
        )
