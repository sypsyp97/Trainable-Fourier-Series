...
class ParallelProjection2DFunction(Function):
    ...
    def forward(
        ctx,
        input: Tensor,
        sinogram_shape: Tensor,
        volume_origin: Tensor,
        detector_origin: Tensor,
        volume_spacing: Tensor,
        detector_spacing: Tensor,
        trajectory,
    ) -> Tensor:
        """
        ...
        Args:
                ...
                ...
        """
        outputs = pyronn_layers.parallel_projection2d(
            input,
            sinogram_shape,
            volume_origin,
            detector_origin,
    ...
    def backward(ctx, grad: Tensor) -> tuple:
        ...
        outputs = pyronn_layers.parallel_backprojection2d(
            grad,
            volume_shape,
            volume_origin,
            detector_origin,
...
class ParallelProjection2D(nn.Module):
    ...
    def forward(self, input: Tensor, **geometry: dict) -> Tensor:
        return ParallelProjection2DFunction.apply(
            input,
            geometry["sinogram_shape"],
...
class FanProjection2DFunction(Function):
    ...
    def forward(
        ...
        volume_spacing: Tensor,
        detector_spacing: Tensor,
        source_isocenter_distance: Tensor,
        source_detector_distance: Tensor,
        trajectory: Tensor,
    ) -> Tensor:
        """
        ...
        Args:
                ...
                ...
        """
        outputs = pyronn_layers.fan_projection2d(
            input,
            sinogram_shape,
            volume_origin,
            detector_origin,
    ...
    def backward(ctx, grad: Tensor) -> tuple:
        ...
        if not grad.is_contiguous():
            grad = grad.contiguous()
        outputs = pyronn_layers.fan_backprojection2d(
            grad,
            volume_shape,
            volume_origin,
            detector_origin,
...
class FanProjection2D(nn.Module):
    ...
    def forward(self, input: Tensor, **geometry: dict) -> Tensor:
        return FanProjection2DFunction.apply(
            input,
            geometry["sinogram_shape"],
            geometry["volume_origin"],
            geometry["detector_origin"],
